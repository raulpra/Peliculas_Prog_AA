      ...
      $.ajax({
        ...
        statusCode: {
          200: function(response) {
            ...
            if (response === "ok") {
              window.location.href = "/peliculas_app/detalle_genero.jsp?genero_id=<%=genero.getId()%>";
            } else {
...
<div class="container mt-5">
  <h2 class="mb-4">Modificar género</h2>
  <form method="post" id="genero-form"  class="shadow p-4 bg-white rounded">
    ...
    <input type="hidden" name="id" value="<%=generoId%>">
    <div id="result"></div>
  </form>
</div>

<%
  } catch (GeneroNotFoundException gnfe){
%>
